...
import { getCrumbFileName, getGlobalCrumbsOutput, GLOBAL_CRUMBS_PATH, GlobalCrumbPatch } from '../src/server/routes/client-files';
...
function applyChanges(crumbs: string, changes: GlobalCrumbPatch): string {
...
(async () => {
  ...
  const autoGeneratedDir = path.join(__dirname, '..', 'media', GLOBAL_CRUMBS_PATH);
