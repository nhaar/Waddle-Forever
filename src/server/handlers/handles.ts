...
const HANDLER_MAPPING: HandlerMapping = {
  ...
  's': {
    ...
    'b': {
      'gb': Handle.GetBuddiesBNested,
      'go': Handle.GetBuddyOnlineBNested,
      'br': Handle.BuddyRequestBNested,
      'ba': Handle.BuddyAcceptBNested,
      'rr': Handle.BuddyDeclineBNested,
      'bm': Handle.BuddyMessageBNested,
      'rb': Handle.BuddyRemoveBNested
    },
    'u': {
