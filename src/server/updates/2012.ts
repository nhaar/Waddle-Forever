...
export const UPDATES_2012: Update[] = [
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleJan2012.swf',
      newItems: [
        132,
        139,
        297,
  ...
  },
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleFeb2012.swf',
      newItems: [
        125,
        182,
        323,
  ...
  },
  {
    date: '2012-03-01',
    clothingCatalog: {
      file: 'archives:PenguinStyleMar2012.swf',
      newItems: [
        301,
        302,
        303,
  ...
  },
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleApr2012.swf',
      newItems: [
        969,
        1135,
        1136,
  ...
  },
  {
    date: '2012-05-03',
    clothingCatalog: {
      file: 'archives:PenguinStyleMay2012.swf',
      newItems: [
        667,
        793,
        798,
  ...
  },
  {
    date: '2012-05-31',
    clothingCatalog: {
      file: 'archives:PenguinStyleJun2012.swf',
      newItems: [
        299,
        301,
        302,
  ...
  },
  {
    ...
    sportCatalog: {
      file: 'archives:Jun2012Sport.swf',
      items: [
        3002,
        254,
        255,
  ...
  },
  {
    date: '2012-07-05',
    clothingCatalog: {
      file: 'archives:PenguinStyleJul2012.swf',
      newItems: [
        1227,
        1263,
        1424,
  ...
  },
  {
    date: '2012-08-02',
    clothingCatalog: {
      file: 'archives:PenguinStyleAug2012.swf',
      newItems: [
        190,
        378,
        384,
  ...
  },
  {
    date: '2012-09-06',
    clothingCatalog: {
      file: 'archives:PenguinStyleSept2012.swf',
      newItems: [
        376,
        966,
        998,
  ...
  },
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleOct2012.swf',
      newItems: [
        789,
        1305,
        1306,
  ...
  },
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleNov2012.swf',
      newItems: [
        299,
        465,
        923,
  ...
  },
  {
    ...
    temp: {
      party: {
        ...
        clothingCatalog: {
          file: 'archives:HerbertStyleNov2012.swf',
          newItems: [],
          removedItems: []
        },
        playScript: [
  ...
  },
  {
    ...
    clothingCatalog: {
      file: 'archives:PenguinStyleDec2012.swf',
      newItems: [
        256,
        342,
        353,
    ...
    sportCatalog: {
      file: 'archives:Dec2012Sport.swf',
      items: [
        3002,
        220,
        277,
