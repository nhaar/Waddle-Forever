...
export const UPDATES_2010: Update[] = [
  {
    date: '2010-01-02',
    clothingCatalog: {
      file: 'archives:January10Style.swf',
      newItems: [
        4159,
        4157,
        4156,
  ...
  },
  {
    date: '2010-02-05',
    clothingCatalog: {
      file: 'archives:Feb10Clothing.swf',
      newItems: [
        223,
        238,
        545,
  ...
  },
  {
    date: '2010-04-01',
    clothingCatalog: {
      file: 'archives:April10Style.swf',
      newItems: [
        660,
        782,
        929,
  ...
  },
  {
    date: '2010-09-03',
    clothingCatalog: {
      file: 'archives:September10Style.swf',
      newItems: [
        110,
        221,
        222,
  ...
  },
  {
    date: '2010-11-05',
    clothingCatalog: {
      file: 'archives:November10Style.swf',
      newItems: [
        131,
        239,
        308,
  ...
  },
  {
    date: '2010-12-03',
    clothingCatalog: {
      file: 'archives:PenguinStyleDec2010.swf',
      newItems: [
        241,
        284,
        289,
