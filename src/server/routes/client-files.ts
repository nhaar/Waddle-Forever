...
import { STAGE_PLAYS, STAGE_TIMELINE } from "../game-logic/stage-plays";
import { IGLOO_LISTS } from "../game-logic/igloo-lists";
...
import { getNewspaperName } from "../game-logic/news.txt";
