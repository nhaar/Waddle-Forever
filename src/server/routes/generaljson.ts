...
export function getGeneralJson(version: Version): string {
  ...
  return JSON.stringify({ "mascot_options": { "migrator_active": findInVersion(version, migratorTimeline) }, "party_options": { "fair_ticket_active": false, "hunt_active": hunt !== undefined, "itemRewardID": hunt?.global.reward ?? 0, "isMapNoteActive": findInVersion(version, mapNoteTimeline), "showPartyAnnouncement": false, "party_icon_active": false }, "igloo_options": { "contestRunning": false }, "oops_test": { "testEnabled": true }, "island_options": { "isDaytime": true }, "party_dates": { "20170201": "2017-01-30" } })
}