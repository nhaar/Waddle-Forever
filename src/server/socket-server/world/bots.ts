...
function addExploreItems(inventory: Set<number>, today: Version, startDate: Version, getChance: number) {
...
function generateRandomInventory(
  ...
  addExploreItems(inventory, data.getDate(), startDate, attrs.exploreFan);
