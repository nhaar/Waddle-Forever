...
export const createWorldXtHandler = (): XtHandler => {
  ...
  const callbacks: IntermediateXtCallbackInfo<any>[] = [
    ...
    r.xt('z', 'zm', ['string', 'string', 'number'], handleSendTreasureHuntMove, { guard: isTableGuard }),
