    ...
    disconnect: function (reason)
    {
        ...
        if (this.connected) {
            ...
            this._disconnectTimeout = this._addSysTimedHandler(
                5000, this._onDisconnectTimeout.bind(this));
            this._sendTerminate();
        }
    },
        ...
        if (req.xhr.readyState == 4) {
            ...
            if (reqStatus == 200) {
                ...
                if (reqStatus === 0 ||
                    ...
                    reqStatus >= 12000) {
                    this._hitError(reqStatus);
                    if (reqStatus >= 400 && reqStatus < 600) {
