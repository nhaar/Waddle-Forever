    ...
    with TemporaryDirectory() as tmpdir:
        ...
        try:
            if engine == "auto":
                ...
                if chosen is None and shutil.which("swfrender") and shutil.which("swfdump"):
                    chosen = "swfrender"
...
def copy_assets(
    ...
    for record in records:
        ...
        extract_preview(dest_swf, dest_png, engine, record.frame, ffdec_exec, preview_zoom)
